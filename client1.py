...
class FindHighUtilityItement:
    ...
    def _findTransactionUtility(self,transcation):
        """total = 0
        for i in transcation.items:
            total += self.unit_profit[i[0]]*i[1]"""
...
print("1",highUtilityItemset)
print("2",up.get_unit_price())
...
class FlowerClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config):
        ...
        for i in new_list_variable:
            if i in res_vaiables:
                tp +=  1
            else:
                fn += 1
        # print(tp,fn)
